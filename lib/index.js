...
function coalesceArguments(length, defaultMsg, message, data) {
  ...
  if (length === 1) {
    if (typeof message === 'string') result.message = message;else result.data = formatErrorData(message);
    return result;
  }
...
function FormatError(message, data) {
  ...
  var result = coalesceArguments(arguments.length, defaultMessage.format, message, data);
...
function ValidationError(message, data) {
  ...
  var result = coalesceArguments(arguments.length, defaultMessage.validation, message, data);
  this.message = result.message;
  this.data = result.data;
...
function CredentialsError(message, data) {
  ...
  var result = coalesceArguments(arguments.length, defaultMessage.credentials, message, data);
  this.message = result.message;
  this.data = result.data;
...
function UnauthorizedError(message, data) {
  ...
  var result = coalesceArguments(arguments.length, defaultMessage.unauthorized, message, data);
  this.message = result.message;
  this.data = result.data;
...
function NotFoundError(message, data) {
  ...
  var result = coalesceArguments(arguments.length, defaultMessage.notFound, message, data);
  this.message = result.message;
  this.data = result.data;
...
function ExistsError(message, data) {
  ...
  var result = coalesceArguments(arguments.length, defaultMessage.exists, message, data);
  this.message = result.message;
  this.data = result.data;
...
function ConcurrencyError(message, data) {
  ...
  var result = coalesceArguments(arguments.length, defaultMessage.concurrency, message, data);
  this.message = result.message;
  this.data = result.data;
...
function TempUnavailableError(message, data) {
  ...
  var result = coalesceArguments(arguments.length, defaultMessage.tempUnavailable, message, data);
  this.message = result.message;
  this.data = result.data;
...
function EnumError(message, data) {
  ...
  var result = coalesceArguments(arguments.length, defaultMessage.enum, message, data);
  this.message = result.message;
  this.data = result.data;
  this.name = 'EnumError';
}
